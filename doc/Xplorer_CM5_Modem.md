...
### Install Modem Manager and reboot
```
...
you must check as well that you ports cdc-wdm0 and wwan0, that means the module is in QMI mode which is good, otherwise go to paragraph 3
